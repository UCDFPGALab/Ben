...
def serialEvent(serialInput):
    ...
    while holder == False:
        ...
        if inByte == '$':
            ...
            serialInput.write('A') # Could be any character
            holder = True;
...
p2 = win.addPlot(title="Upset rate versus Time")
p3 = win.addPlot(title = "Upset rate versus Current")
win.nextRow()
...
while True:
    ...
    if time.mktime(time.gmtime()) - superClock > 1:
        ...
        p2.plot(timing, rate, pen=(200,200,200), symbolBrush=(255,0,0))        
